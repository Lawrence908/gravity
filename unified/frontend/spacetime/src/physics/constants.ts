...
/**
 * Scale factor below which the photon–baryon plasma renders the universe
 * opaque to light.  In the real universe, recombination (z ≈ 1100, a ≈ 0.001)
 * is when the CMB is released and the universe first becomes transparent.
 * We set a slightly higher threshold so the fog is visible at simulation start.
 */
export const OPACITY_THRESHOLD_A = 0.012;
